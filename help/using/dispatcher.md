...
1. Instale un [servidor web admitido](https://helpx.adobe.com/es/experience-manager/6-5/sites/deploying/using/technical-requirements.html) según la documentación del servidor web.
