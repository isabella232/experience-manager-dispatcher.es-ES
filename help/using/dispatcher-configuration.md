...
>[!NOTE]
>
>Los filtros `0030` y `0031` relativos a Dynamic Media se aplican a la versión 6.0 de AEM y posteriores.
...
* Para ignorar un parámetro, cree una propiedad glob que lo permita.
